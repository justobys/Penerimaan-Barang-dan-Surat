                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <form action="<?= base_url('DaftarSurat/ubahSurat/' . $surat['id']) ?>"
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" id="deskripsi" name="deskripsi"
                                                        ...
                                                        readonly><?= $surat['deskripsi'] ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="id_pegawai" name="id_pegawai"
                                                        ...
                                                        <?php foreach ($dataPegawai as $pegawai): ?>
                                                            <option value="<?= $pegawai['id_pegawai'] ?>" <?php if ($surat['id_pegawai'] == $pegawai['id_pegawai']): ?>selected<?php endif; ?> disabled>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" class="form-control-file" id="foto_surat"
                                                        name="foto_surat" accept="image/*" disabled>
                                                </div>
                                                <div class="form-group mt-4">
                                                    <label for="status">Status</label>
                                                    <select class="form-control" id="status" name="status" required>
                                                        <option value="Belum Diterima" <?= ($surat['status'] == 'Belum Diterima') ? 'selected' : '' ?>>
                                                            Belum Diterima
                                                        </option>
